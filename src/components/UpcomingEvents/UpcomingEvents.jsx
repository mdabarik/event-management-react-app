...
const UpcomingEvents = () => {
    ...
    return (
        <div className="container w-[90%] md:w-[100%] flex flex-col justify-center items-center mx-auto mb-8">
            ...
            <p className="text-[8px] md:text-sm w-[80%] flex mt-3 text-center">Join us for thrilling events! Live music, workshops, art exhibits, and more! Mark your calendars and don't miss out!</p>
